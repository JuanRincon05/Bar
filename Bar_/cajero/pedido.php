<?php
// este imprime en un documento de word el carrito en forma de factura
...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5 offset-md-7 d-grid gap-2">
                    <button class="btn btn-primary btn-lg">pago</button>
                </div>
    ...
    <script>
        ...
        function actualizaCantidad(cantidad, id) {
            let url = '../mesero/clases/actualizar_pedidos.php'
